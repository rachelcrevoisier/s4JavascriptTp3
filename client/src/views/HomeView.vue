                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-outline-dark mt-auto" @click="add(product.name, i)">Ajouter au panier</a>
                                    <p>
                                        <RouterLink :to="{name: 'product', params: {id: product.name}}">Voir plus..</RouterLink>
                                    </p>
                                </div>
                            </div>
                        </div>
